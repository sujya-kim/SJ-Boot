...
public class JwtTokenAuthenticationProcessingFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        JwtAuthenticationToken authenticationToken = (JwtAuthenticationToken) getAuthenticationManager()
                .authenticate(new JwtAuthenticationToken(token));
        String role = authenticationToken.getAuthorities().toArray()[0].toString();
